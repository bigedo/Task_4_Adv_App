package com.example.bigedo.task_4_adv_app;
...
import com.example.bigedo.task_4_adv_app.BlankFragment.OnFragmentInteractionListener;
...
public class MainActivity extends AppCompatActivity
    ...
    private void swapFragment(String id) {
        ...
        } else if (id.equals("transaction")) {
            ft.replace(R.id.main_fragment, transactionFragment);
        } else if (id.equals("fab")){
